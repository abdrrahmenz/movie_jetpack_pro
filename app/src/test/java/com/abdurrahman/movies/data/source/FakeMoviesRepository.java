...
public class FakeMoviesRepository implements MoviesDataSource {
    ...
    FakeMoviesRepository(@NonNull RemoteRepository remoteRepository, LocalDataSource localDataSource, AppExecutors appExecutors) {
        this.remoteRepository = remoteRepository;
        this.localDataSource = localDataSource;
        this.appExecutors = appExecutors;
    }

    public static FakeMoviesRepository getInstance(RemoteRepository remoteData, LocalDataSource localDataSource, AppExecutors appExecutors) {
        if (INSTANCE == null) {
            synchronized (FakeMoviesRepository.class) {
                if (INSTANCE == null) {
                    INSTANCE = new FakeMoviesRepository(remoteData, localDataSource, appExecutors);
                }
            }
        }
        return INSTANCE;
