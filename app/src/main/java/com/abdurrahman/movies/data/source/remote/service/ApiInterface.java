...
public interface ApiInterface {
    ...
    @GET("3/movie/{movieId}")
    Call<MovieDetailsResponse> getDetailMovies(@Path("movieId") int movieId, @Query("api_key") String apiKey);

    @GET("3/tv/{tvId}")
    Call<TVShowDetailsResponse> getDetailTVShows(@Path("tvId") int tvId, @Query("api_key") String apiKey);
}
